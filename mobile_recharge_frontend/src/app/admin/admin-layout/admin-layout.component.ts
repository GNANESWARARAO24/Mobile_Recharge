...
@Component({
  ...
  styleUrls: ['./admin-layout.component.css'], // Or .css if not using Sass
  imports: [
    // Required for common Angular directives
    RouterModule, // <-- ADD RouterModule TO IMPORTS HERE
    // If your layout HTML uses NgModel
    // If your layout HTML uses formGroup, formControlName
  ],
})
